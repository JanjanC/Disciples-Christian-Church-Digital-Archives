...
describe ('Attendance Controller', () => {
    ...
    describe('Level one access', () => {        
        ...
        it('Should be able to get the edit attendance page if editId matches', () => {
            ...
            sinon.assert.calledWith(res.render, 'edit-attendance', sinon.match({attendeesMembers: expectedResult.attendeesMembers}));
            sinon.assert.calledWith(res.render, 'edit-attendance', sinon.match({attendeesNonMembers: expectedResult.attendeesNonMembers}));
            sinon.assert.calledWith(res.render, 'edit-attendance', sinon.match({attendees: expectedResult.attendees}));
